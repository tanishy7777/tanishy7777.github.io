...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "A few of my github repositories, if you want to have a look at my projects instead see the projects tab on the navbar",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%32%33%31%31%30%33%32%38@%69%69%74%67%6E.%61%63.%69%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/tanishy7777", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/tanish-yelgoe-a04a57291", "_blank");
        },
      },{
      id: 'light-theme',
